...
def convert_velocity(value, unit):
    ...
    if unit == "m/s":
        ...
        raise ValueError("Unsupported velocity unit. Please use m/s, ft/s, km/s, or mi/s.")
...
def convert_acceleration(value, unit):
    ...
    if unit == "m/s^2":
        ...
        raise ValueError("Unsupported acceleration unit. Please use m/s^2, ft/s^2, km/s^2, or mi/s^2.")
